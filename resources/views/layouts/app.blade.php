...
<head>
    ...
    <meta name="keywords" content="chaîne telegram français,catalogue telegram français, chaînes telegram, annuaire telegram français, classeement telegram français, channels telegram, chaine telegram, telegram français, telegram francophone, canal telegram français">
    ...
    <script data-ad-client="ca-pub-8740002972429362" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>

    <!-- Global site tag (gtag.js) - Google Ads: 756697316 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-756697316"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'AW-756697316');
    </script>

    <!-- Event snippet for Website traffic conversion page -->
    <script>
        gtag('event', 'conversion', {'send_to': 'AW-756697316/JZ_CCPyRyOoBEOSR6egC'});
    </script>
